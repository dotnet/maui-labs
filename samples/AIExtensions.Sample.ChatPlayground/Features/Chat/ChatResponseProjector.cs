...
internal sealed class ChatResponseProjector(
    TranscriptEmitter transcript,
    ...
    bool structuredJson)
{
    ...
    private readonly Dictionary<string, (long EntryId, string Arguments)> _toolEntriesByCallId =
