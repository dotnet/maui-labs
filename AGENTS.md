...
| **AIExtensions** | `Microsoft.Maui.AI.Attributes`, `Microsoft.Maui.AI.Chat*`, `Microsoft.Maui.Chat.Controls`, `Microsoft.Maui.CopilotSdk` | Source-generated AI tools, the headless block/pipeline agent engine, provider-neutral and AI-specific native chat controls, and a GitHub Copilot SDK `IChatClient` adapter. |
