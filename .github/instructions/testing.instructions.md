...
| AIExtensions | `tests/AIExtensions/Microsoft.Maui.AI.Chat.Controls.Blazor.Tests/` | `net10.0` |
| AIExtensions | `tests/AIExtensions/Microsoft.Maui.Chat.Tests/` | `net10.0` |
| AIExtensions | `tests/AIExtensions/Microsoft.Maui.Chat.Controls.Tests/` | `net10.0` |
| AIExtensions | `tests/AIExtensions/Microsoft.Maui.Chat.Controls.Blazor.Tests/` | `net10.0` |
| AIExtensions samples | `tests/AIExtensions/AIChat.ClientServer.Sample.Tests/` | `net10.0` |
