...
internal static class DevFlowSkillManager
{
    ...
    [
        ...
        new("maui-devflow-ci-triage", "MAUI DevFlow CI Evidence", "Diagnostic-only CI evidence and local reproduction handoff; no run or repair authority.", Recommended: false)
    ];
