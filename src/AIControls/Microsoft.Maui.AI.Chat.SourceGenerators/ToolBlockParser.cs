...
namespace Microsoft.Maui.AI.Chat.SourceGenerators;

internal static class ToolBlockParser
{
    private const string ToolBlockAttributeFullName = "Microsoft.Maui.AI.Chat.ToolBlockAttribute";
    private const string ToolParameterAttributeFullName = "Microsoft.Maui.AI.Chat.ToolParameterAttribute";
    private const string ToolResultAttributeFullName = "Microsoft.Maui.AI.Chat.ToolResultAttribute";
    private const string FunctionInvocationContentBlockFullName = "Microsoft.Maui.AI.Chat.FunctionInvocationContentBlock";
