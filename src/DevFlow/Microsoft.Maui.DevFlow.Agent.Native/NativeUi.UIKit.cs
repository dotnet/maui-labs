...
internal static partial class NativeUi
{
    ...
    /// </summary>
    static UIScrollView? FindScrollView(object? viewObject)
        => FindSelfOrAncestor(
            viewObject,
            static candidate => candidate is UIScrollView,
            static candidate => (candidate as UIView)?.Superview) as UIScrollView;
