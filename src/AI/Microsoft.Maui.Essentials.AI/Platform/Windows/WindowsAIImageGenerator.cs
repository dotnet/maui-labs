...
/// </list>
/// Multiple original images are not supported because the request does not identify a mask.
/// </remarks>
...
public sealed class WindowsAIImageGenerator : IImageGenerator
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		var sources = await DecodeSourceImagesAsync(originalImages).ConfigureAwait(false);
