...
namespace Comet
{
	public static class FontExtensions
	{
		...
		public static T CharacterSpacing<T>(this T view, double value) where T : View
			=> view.SetEnvironment(nameof(ITextStyle.CharacterSpacing), (object)value, true);
		public static T CharacterSpacing<T>(this T view, Func<double> value) where T : View
			=> view.CharacterSpacing(value());
