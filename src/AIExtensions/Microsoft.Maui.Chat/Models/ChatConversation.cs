...
/// </para>
/// </remarks>
public abstract class ChatConversation : ObservableChatObject
{
    ...
    private ChatParticipant? _localParticipant;
    private ChatConversationStatus _status;
    ...
    {
        get => _localParticipant;
        set => SetProperty(ref _localParticipant, value);
    }
    ...
    public ChatConversationStatus Status
    {
        ...
        protected set
        {
            if (SetProperty(ref _status, value))
                RaiseChange(ChatConversationChange.StatusChanged(value));
        }
    }
